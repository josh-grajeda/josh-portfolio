      ...
      <section className="my-12 px-5" id="projects">
                ...
                workHistory.map((work) => (
                  <div className="cd-timeline-block" key={work.id}>
                    ...
                    <div className="cd-timeline-content">
                      <h1 className="uppercase font-bold text-2xl pl-3 pt-2 flex h1-orange">
                        {work?.companyName}
                      </h1>
                      <h4
                        className="uppercase font-bold text-base pl-3 pt-2"
                        key={work.id}
                      >
                        {work?.role}
                      </h4>
                      ...
                      <div className="timeline-content-info">
                        <h5 className="text-sm" key={work.id}>
                          {work.duration}
                        </h5>
                      </div>
                      <div className="pl-2">
        ...
        <div className="lg:block lg:invisible grid place-items-center">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-6 py-3 text-white no-underline bg-josh-orange rounded hover:bg-black hover:text-white"
          >
            Resume
          </a>
        </div>
